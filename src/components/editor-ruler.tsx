...
//   const [rulerWidth, setRulerWidth] = useState(containerWidth); // Default max-w-4xl width
...
//       const maxMargin = rulerWidth * 0.4; // Max 40% of width
//       const minMargin = 0;

//       if (isDraggingLeft) {
//         const newMargin = Math.max(minMargin, Math.min(maxMargin, x));
...
//           minMargin,
//           Math.min(maxMargin, rulerWidth - x)
//         );
...
//   // Generate tick marks (every 10px = 10cm, with major ticks every 100px = 100cm)
//   const ticks: ReactNode[] = [];
//   const tickInterval = 10; // 10px = 10cm
//   const majorTickInterval = 100; // 100px = 100cm
//   const maxTick = Math.ceil(rulerWidth / tickInterval) * tickInterval;

//   for (let i = 0; i <= maxTick; i += tickInterval) {
//     const isMajor = i % majorTickInterval === 0;
//     const isFiftyCm = i % 50 === 0;

//     ticks.push(
//       <div
//         key={i}
//         className={cn(
//           "absolute top-0 border-border border-l",
//           isMajor ? "h-3 border-primary" : "h-2",
//           isFiftyCm ? "border-primary" : "border-border"
//         )}
//         style={{ left: `${i}px` }}
//       >
//         {isMajor && (
//           <span className="-bottom-4 -translate-x-1/2 absolute left-1/2 select-none whitespace-nowrap text-[10px] text-foreground">
//             {i}
//           </span>
//         )}
//       </div>
...
//     <div
//       ref={rulerRef}
//       className="relative mx-4 lg:mx-auto h-8 bg-muted/30"
